...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\section{Koncept kontraktů softwarových modulů}	
		...
		\subsubsection{Sémantické kontrakty}
			...
			%\footnote{Jedná se o vstupní podmínky, které kladou požadavky na vstupní argumenty operace.} \footnote{Jedná se o výstupní podmínky, které kladou požadavky na výstup operace.} \footnote{Podmínky, které platí po celou dobu operace}
